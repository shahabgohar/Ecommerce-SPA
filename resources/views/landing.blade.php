...
<head>
  ...
  <!-- Bootstrap core CSS -->
  <!-- <link href="{{asset('template_dep/css/bootstrap.min.css')}}" rel="stylesheet"> -->
  <link href="{{ asset('css/app.css') }}" rel="stylesheet">
  <!-- Material Design Bootstrap -->
  <link href="{{asset('template_dep/css/mdb.min.css')}}" rel="stylesheet">
  <!-- Your custom styles (optional) -->
  <link href="{{asset('template_dep/css/style.min.css')}}" rel="stylesheet">

  <script src="{{ asset('js/app.js') }}" defer></script>

  <script type="text/javascript" src="{{asset('template_dep/js/mdb.min.js')}}"></script>
  <style type="text/css">
    html,
    body,
    header,
...
<body>
  ...
  <div class="cotainer nav-justified">
  <ul class="nav nav-pills bg-light" style="margin-bottom:10px;" >
            <li class="nav-item active">
  ...
  <!-- SCRIPTS -->
  <!-- JQuery -->
  <!-- <script type="text/javascript" src="{{asset('template_dep/js/jquery-3.4.1.min.js')}}"></script> -->

  <!-- Bootstrap tooltips -->
  <!-- <script type="text/javascript" src="{{asset('template_dep/js/popper.min.js')}}"></script> -->
  <!-- Bootstrap core JavaScript -->
  <!-- <script type="text/javascript" src="{{asset('template_dep/js/bootstrap.min.js')}}"></script> -->
  <!-- MDB core JavaScript -->
