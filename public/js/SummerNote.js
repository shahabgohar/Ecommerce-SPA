        ...
        if (this.options.codeviewIframeFilter) {
          ...
          value = value.replace(/(<iframe.*?>.*?(?:<\/iframe>)?)/gi, function (tag) {
            ...
            for (var _i = 0, whitelist_2 = whitelist_1; _i < whitelist_2.length; _i++) {
              var src = whitelist_2[_i]; // pass if src is trusted
...
module.exports = __webpack_require__(/*! /root/Desktop/ecommerce-final/ecommerce/resources/js/SummerNote.js */"./resources/js/SummerNote.js");
